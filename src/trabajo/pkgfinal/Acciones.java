...
public class Acciones extends javax.swing.JFrame {
    ...
    public void savebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebtnActionPerformed
        ...
        if(resp==JFileChooser.APPROVE_OPTION){
            ...
            File file=new File(dir+"\\"+"I_Love_POO.txt");
            file.createNewFile();
            FileWriter fw=new FileWriter(file, true);
            BufferedWriter bw=new BufferedWriter(fw);
            bw.write(content);
            bw.close();
            String msg="El archivo se ha guardado exitosamente en: "+dirnom;
