...
private JButton añadir, eliminar, borrarLista, editar; // Botones
...
añadir.setBounds(140, 150, 80, 23); /* Establece la posición del
...
editar.setBounds(30, 150, 80, 23); /* Establece la posición del botón Editar persona */
/* Agrega al botón un ActionListener para que gestione eventos
del botón */
...
if (evento.getSource() == editar) { /* Si se pulsa el botón editar */
editarPersona(listaNombres.getSelectedIndex()); // Se invoca borrar editar
}
}
